...
class BettingAnalyticsController extends Controller
{
    ...
    private function generateBettingAnalytics(string $timeframe, string $betType): array
    {
        ...
        return [
            ...
            'monthly_performance' => [
                ['month' => 'Mar 2026', 'bets' => (int) floor(89 * $timeframeMultiplier / 12), 'profit' => (int) floor(890 * $timeframeMultiplier / 12), 'roi' => 0.095],
                ['month' => 'Feb 2026', 'bets' => (int) floor(76 * $timeframeMultiplier / 12), 'profit' => (int) floor(456 * $timeframeMultiplier / 12), 'roi' => 0.062],
                ['month' => 'Jan 2026', 'bets' => (int) floor(82 * $timeframeMultiplier / 12), 'profit' => (int) floor(799 * $timeframeMultiplier / 12), 'roi' => 0.098],
            ],
